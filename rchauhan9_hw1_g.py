...
# Boolean variables r, g, b for each node in graph G
r0 = Bool("r0")
g0 = Bool("g0")
b0 = Bool("b0")
...
edge03_f = And( Or(Not(r0), Not(r3)), Or(Not(g0), Not(g3)), Or(Not(b0), Not(b3)) )
...
final_formula = And(node0_f, node1_f, node2_f, node3_f,
                    edge01_f, edge02_f, edge03_f,
                    edge12_f, edge13_f, edge23_f)
